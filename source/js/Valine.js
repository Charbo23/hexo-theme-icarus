! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("Valine", [], t) : "object" == typeof exports ? exports.Valine = t() : e.Valine = t() }(this, function() {
    return function(e) {
        function t(r) { if (n[r]) return n[r].exports; var i = n[r] = { i: r, l: !1, exports: {} }; return e[r].call(i.exports, i, i.exports, t), i.l = !0, i.exports }
        var n = {};
        return t.m = e, t.c = n, t.i = function(e) { return e }, t.d = function(e, n, r) { t.o(e, n) || Object.defineProperty(e, n, { configurable: !1, enumerable: !0, get: r }) }, t.n = function(e) { var n = e && e.__esModule ? function() { return e.default } : function() { return e }; return t.d(n, "a", n), n }, t.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, t.p = "/dist/", t(t.s = 11)
    }([function(e, t, n) {
        ...
        function l(e) { return e.replace(_, "&lt;").replace(z, "&gt;") }
        ...
        function p(e) { return e.replace(T, '"') }

        function d(e) { return e.replace(L, function(e, t) { return "x" === t[0] || "X" === t[0] ? String.fromCharCode(parseInt(t.substr(1), 16)) : String.fromCharCode(parseInt(t, 10)) }) }

        function h(e) { return e.replace(q, ":").replace(I, " ") }

        function f(e) { for (var t = "", n = 0, r = e.length; n < r; n++) t += e.charCodeAt(n) < 32 ? " " : e.charAt(n); return A.trim(t) }

        function g(e) { return e = p(e), e = d(e), e = h(e), e = f(e) }

        function m(e) { return e = u(e), e = l(e) }
        ...
        function y(e) { return e.replace(j, "") }

        function x(e) { var t = e.split(""); return t = t.filter(function(e) { var t = e.charCodeAt(0); return 127 !== t && (!(t <= 31) || (10 === t || 13 === t)) }), t.join("") }
        var w = n(0).FilterCSS,
        ...
        function o(e, t, n) {
            ...
            var o = "",
                ...
                p = "",
                d = "";
            for (c = 0; c < u; c++) { var h = e.charAt(c); if (!1 === s) { if ("<" === h) { s = c; continue } } else if (!1 === l) { if ("<" === h) { o += n(e.slice(a, c)), s = c, a = c; continue } if (">" === h) { o += n(e.slice(a, s)), d = e.slice(s, c + 1), p = r(d), o += t(s, o.length, p, d, i(d)), a = c + 1, s = !1; continue } if (('"' === h || "'" === h) && "=" === e.charAt(c - 1)) { l = h; continue } } else if (h === l) { l = !1; continue } }
            ...
            for (var r = 0, i = [], o = !1, a = e.length, c = 0; c < a; c++) {
                ...
                if (!1 !== o || "=" !== g)
                    if (!1 === o || c !== r || '"' !== g && "'" !== g || "=" !== e.charAt(c - 1))
                        if (/\s|\n|\t/.test(g)) { if (e = e.replace(/\s|\n|\t/g, " "), !1 === o) { if (-1 === (f = s(e, c))) { h = p.trim(e.slice(r, c)), n(h), o = !1, r = c + 1; continue } c = f - 1; continue } if (-1 === (f = l(e, c - 1))) { h = p.trim(e.slice(r, c)), h = u(h), n(o, h), o = !1, r = c + 1; continue } } else;
                else {
        ...
        ! function(i) {
            ...
            function u(e, t, n, r, i, o, a) { return s(t ^ n ^ r, e, t, i, o, a) }

            function p(e, t, n, r, i, o, a) { return s(n ^ (t | ~r), e, t, i, o, a) }
            ...
            function g(e) { return h(d(f(e), 8 * e.length)) }
            ...
            function y(e) { return g(b(e)) }

            function x(e) { return v(y(e)) }

            function w(e, t) { return m(b(e), b(t)) }

            function k(e, t) { return v(w(e, t)) }

            function A(e, t, n) { return t ? n ? w(t, e) : k(t, e) : n ? y(e) : x(e) } void 0 !== (r = function() { return A }.call(t, n, t, e)) && (e.exports = r)
        }()
    }, function(e, t, n) {
        (function(t) {
            ! function(t) {
                ...
                function n(e) { this.tokens = [], this.tokens.links = Object.create(null), this.options = e || b.defaults, this.rules = y.normal, this.options.pedantic ? this.rules = y.pedantic : this.options.gfm && (this.options.tables ? this.rules = y.tables : this.rules = y.gfm) }

                function r(e, t) {
                    if (this.options = t || b.defaults, this.links = e, this.rules = x.normal, this.renderer = this.options.renderer || new i, this.renderer.options = this.options, !this.links) throw new Error("Tokens array requires a `links` property.");
                    this.options.pedantic ? this.rules = x.pedantic : this.options.gfm && (this.options.breaks ? this.rules = x.breaks : this.rules = x.gfm)
                }

                function i(e) { this.options = e || b.defaults }

                function o() {}

                function a(e) { this.tokens = [], this.token = null, this.options = e || b.defaults, this.options.renderer = this.options.renderer || new i, this.renderer = this.options.renderer, this.renderer.options = this.options, this.slugger = new s }

                function s() { this.seen = {} }

                function l(e, t) { if (t) { if (l.escapeTest.test(e)) return e.replace(l.escapeReplace, function(e) { return l.replacements[e] }) } else if (l.escapeTestNoEncode.test(e)) return e.replace(l.escapeReplaceNoEncode, function(e) { return l.replacements[e] }); return e }

                function c(e) { return e.replace(/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi, function(e, t) { return t = t.toLowerCase(), "colon" === t ? ":" : "#" === t.charAt(0) ? "x" === t.charAt(1) ? String.fromCharCode(parseInt(t.substring(2), 16)) : String.fromCharCode(+t.substring(1)) : "" }) }

                function u(e, t) { return e = e.source || e, t = t || "", { replace: function(t, n) { return n = n.source || n, n = n.replace(/(^|[^\[])\^/g, "$1"), e = e.replace(t, n), this }, getRegex: function() { return new RegExp(e, t) } } }

                function p(e, t, n) { if (e) { try { var r = decodeURIComponent(c(n)).replace(/[^\w:]/g, "").toLowerCase() } catch (e) { return null } if (0 === r.indexOf("javascript:") || 0 === r.indexOf("vbscript:") || 0 === r.indexOf("data:")) return null } t && !k.test(n) && (n = d(t, n)); try { n = encodeURI(n).replace(/%25/g, "%") } catch (e) { return null } return n }

                function d(e, t) { return w[" " + e] || (/^[^:]+:\/*[^\/]*$/.test(e) ? w[" " + e] = e + "/" : w[" " + e] = m(e, "/", !0)), e = w[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^\/]*)[\s\S]*/, "$1") + t : e + t }

                function h() {}

                function f(e) { for (var t, n, r = 1; r < arguments.length; r++) { t = arguments[r]; for (n in t) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]) } return e }
                ...
                function b(e, t, r) {
                    ...
                    if (r || "function" == typeof t) {
                        ...
                        var i, o, s = t.highlight,
                            c = 0;
                        try { i = n.lex(e, t) } catch (e) { return r(e) } o = i.length;
                        var u = function(e) { if (e) return t.highlight = s, r(e); var n; try { n = a.parse(i, t) } catch (t) { e = t } return t.highlight = s, e ? r(e) : r(null, n) };
                        if (!s || s.length < 3) return u();
                        if (delete t.highlight, !o) return u();
                        for (; c < i.length; c++) ! function(e) { "code" !== e.type ? --o || u() : s(e.text, e.lang, function(t, n) { return t ? u(t) : null == n || n === e.text ? --o || u() : (e.text = n, e.escaped = !0, void(--o || u())) }) }(i[c])
                    } else try { return t && (t = f({}, b.defaults, t)), a.parse(n.lex(e, t), t) } catch (e) { if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (t || b.defaults).silent) return "<p>An error occurred:</p><pre>" + l(e.message + "", !0) + "</pre>"; throw e }
                }
                ...
                y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, y._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, y.def = u(y.def).replace("label", y._label).replace("title", y._title).getRegex(), y.bullet = /(?:[*+-]|\d{1,9}\.)/, y.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/, y.item = u(y.item, "gm").replace(/bull/g, y.bullet).getRegex(), y.list = u(y.list).replace(/bull/g, y.bullet).replace("hr", "\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + y.def.source + ")").getRegex(), y._tag = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", y._comment = /<!--(?!-?>)[\s\S]*?-->/, y.html = u(y.html, "i").replace("comment", y._comment).replace("tag", y._tag).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), y.paragraph = u(y.paragraph).replace("hr", y.hr).replace("heading", y.heading).replace("lheading", y.lheading).replace("tag", y._tag).getRegex(), y.blockquote = u(y.blockquote).replace("paragraph", y.paragraph).getRegex(), y.normal = f({}, y), y.gfm = f({}, y.normal, { fences: /^ {0,3}(`{3,}|~{3,})([^`\n]*)\n(?:|([\s\S]*?)\n)(?: {0,3}\1[~`]* *(?:\n+|$)|$)/, paragraph: /^/, heading: /^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/ }), y.gfm.paragraph = u(y.paragraph).replace("(?!", "(?!" + y.gfm.fences.source.replace("\\1", "\\2") + "|" + y.list.source.replace("\\1", "\\3") + "|").getRegex(), y.tables = f({}, y.gfm, { nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/, table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/ }), y.pedantic = f({}, y.normal, { html: u("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment", y._comment).replace(/tag/g, "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(), def: /^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/ }), n.rules = y, n.lex = function(e, t) { return new n(t).lex(e) }, n.prototype.lex = function(e) { return e = e.replace(/\r\n|\r/g, "\n").replace(/\t/g, "    ").replace(/\u00a0/g, " ").replace(/\u2424/g, "\n"), this.token(e, !0) }, n.prototype.token = function(e, t) {
                    ...
                    for (var n, r, i, o, a, s, l, c, u, p, d, h, f, v, b, x; e;)
                        if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), i[0].length > 1 && this.tokens.push({ type: "space" })), i = this.rules.code.exec(e)) e = e.substring(i[0].length), i = i[0].replace(/^ {4}/gm, ""), this.tokens.push({ type: "code", text: this.options.pedantic ? i : m(i, "\n") });
                    ...
                    else if (t && (i = this.rules.nptable.exec(e)) && (s = { type: "table", header: g(i[1].replace(/^ *| *\| *$/g, "")), align: i[2].replace(/^ *|\| *$/g, "").split(/ *\| */), cells: i[3] ? i[3].replace(/\n$/, "").split("\n") : [] }, s.header.length === s.align.length)) {
                        ...
                        for (e = e.substring(i[0].length), o = i[2], v = o.length > 1, l = { type: "list_start", ordered: v, start: v ? +o : "", loose: !1 }, this.tokens.push(l), i = i[0].match(this.rules.item), c = [], n = !1, f = i.length, d = 0; d < f; d++) s = i[d], p = s.length, s = s.replace(/^ *([*+-]|\d+\.) */, ""), ~s.indexOf("\n ") && (p -= s.length, s = this.options.pedantic ? s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + p + "}", "gm"), "")), d !== f - 1 && (a = y.bullet.exec(i[d + 1])[0], (o.length > 1 ? 1 === a.length : a.length > 1 || this.options.smartLists && a !== o) && (e = i.slice(d + 1).join("\n") + e, d = f - 1)), r = n || /\n\n(?!\s*$)/.test(s), d !== f - 1 && (n = "\n" === s.charAt(s.length - 1), r || (r = n)), r && (l.loose = !0), b = /^\[[ xX]\] /.test(s), x = void 0, b && (x = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")), u = { type: "list_item_start", task: b, checked: x, loose: r }, c.push(u), this.tokens.push(u), this.token(s, !1), this.tokens.push({ type: "list_item_end" });
                        if (l.loose)
                    ...
                    else if (t && (i = this.rules.def.exec(e))) e = e.substring(i[0].length), i[3] && (i[3] = i[3].substring(1, i[3].length - 1)), h = i[1].toLowerCase().replace(/\s+/g, " "), this.tokens.links[h] || (this.tokens.links[h] = { href: i[2], title: i[3] });
                    else if (t && (i = this.rules.table.exec(e)) && (s = { type: "table", header: g(i[1].replace(/^ *| *\| *$/g, "")), align: i[2].replace(/^ *|\| *$/g, "").split(/ *\| */), cells: i[3] ? i[3].replace(/(?: *\| *)?\n$/, "").split("\n") : [] }, s.header.length === s.align.length)) {
                        for (e = e.substring(i[0].length), d = 0; d < s.align.length; d++) /^ *-+: *$/.test(s.align[d]) ? s.align[d] = "right" : /^ *:-+: *$/.test(s.align[d]) ? s.align[d] = "center" : /^ *:-+ *$/.test(s.align[d]) ? s.align[d] = "left" : s.align[d] = null;
                ...
                x._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", x.em = u(x.em).replace(/punctuation/g, x._punctuation).getRegex(), x._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g, x._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, x._email = /[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, x.autolink = u(x.autolink).replace("scheme", x._scheme).replace("email", x._email).getRegex(), x._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, x.tag = u(x.tag).replace("comment", y._comment).replace("attribute", x._attribute).getRegex(), x._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, x._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*)/, x._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, x.link = u(x.link).replace("label", x._label).replace("href", x._href).replace("title", x._title).getRegex(), x.reflink = u(x.reflink).replace("label", x._label).getRegex(), x.normal = f({}, x), x.pedantic = f({}, x.normal, { strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/, em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/, link: u(/^!?\[(label)\]\((.*?)\)/).replace("label", x._label).getRegex(), reflink: u(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", x._label).getRegex() }), x.gfm = f({}, x.normal, { escape: u(x.escape).replace("])", "~|])").getRegex(), _extended_email: /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/, url: /^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, _backpedal: /(?:[^?!.,:;*_~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_~)]+(?!$))+/, del: /^~+(?=\S)([\s\S]*?\S)~+/, text: u(x.text).replace("]|", "~]|").replace("|$", "|https?://|ftp://|www\\.|[a-zA-Z0-9.!#$%&'*+/=?^_`{\\|}~-]+@|$").getRegex() }), x.gfm.url = u(x.gfm.url, "i").replace("email", x.gfm._extended_email).getRegex(), x.breaks = f({}, x.gfm, { br: u(x.br).replace("{2,}", "*").getRegex(), text: u(x.gfm.text).replace("{2,}", "*").getRegex() }), r.rules = x, r.output = function(e, t, n) { return new r(t, n).output(e) }, r.prototype.output = function(e) {
                    for (var t, n, i, o, a, s, c = ""; e;)
                        ...
                        e = e.substring(a[0].length), this.inLink = !0, i = a[2], this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i), t ? (i = t[1], o = t[3]) : o = "") : o = a[3] ? a[3].slice(1, -1) : "", i = i.trim().replace(/^<([\s\S]*)>$/, "$1"), c += this.outputLink(a, { href: r.escapes(i), title: r.escapes(o) }), this.inLink = !1
                ...
                }, l.escapeTest = /[&<>"']/, l.escapeReplace = /[&<>"']/g, l.replacements = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, l.escapeTestNoEncode = /[<>"']|&(?!#?\w+;)/, l.escapeReplaceNoEncode = /[<>"']|&(?!#?\w+;)/g;
                var w = {},
                    k = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;
                h.exec = h, b.options = b.setOptions = function(e) { return f(b.defaults, e), b }, b.getDefaults = function() { return { baseUrl: null, breaks: !1, gfm: !0, headerIds: !0, headerPrefix: "", highlight: null, langPrefix: "language-", mangle: !0, pedantic: !1, renderer: new i, sanitize: !1, sanitizer: null, silent: !1, smartLists: !1, smartypants: !1, tables: !0, xhtml: !1 } }, b.defaults = b.getDefaults(), b.Parser = a, b.parser = a.parse, b.Renderer = i, b.TextRenderer = o, b.Lexer = n, b.lexer = n.lex, b.InlineLexer = r, b.inlineLexer = r.output, b.Slugger = s, b.parse = b, e.exports = b
        ...
        (function(t) {
            ...
            function n(e) { var t = new Error(e); return t.name = "ValueError", t }
            ...
            function r(e) {
                return function(t) {
                    ...
                    return t.replace(/([{}])\1|[{](.*?)(?:!(.+?))?[}]/g, function(t, a, s, l) {
                        ...
                        var u = c.split("."),
                            p = (/^\d+$/.test(u[0]) ? u : ["0"].concat(u)).reduce(function(e, t) { return e.reduce(function(e, n) { return null != n && t in Object(n) ? ["function" == typeof n[t] ? n[t]() : n[t]] : [] }, []) }, [r]).reduce(function(e, t) { return t }, "");
                        if (null == l) return p;
            ...
            i.create = r, i.extend = function(e, n) {
                var i = r(n);
                e.format = function() { var e = Array.prototype.slice.call(arguments); return e.unshift(this), i.apply(t, e) }
            }, e.exports = i
        }).call(this, this)
    }, function(e, t, n) {
        var r = n(12);
        ...
        var o = n(7),
            ...
            m = function() {
                ...
                return i(e, [{
                    ...
                    value: function(e) {
                        ...
                        var r = e.lang || "en";
                        t.i18n = e.i18n || c[r], e.admin_email ? t.adminEmailHash = s(e.admin_email.toLowerCase().trim()) : t.adminEmailHash = null, u.url = e.pathname || location.pathname.replace(/\/$/, "");
                        try {
                            ...
                            t.nodata = { show: function(e) { g.innerHTML = e || t.i18n.no_comment_yet, g.setAttribute("style", "display:block;") }, hide: function() { g.setAttribute("style", "display:none;") } }, t.nodata.show();
                            ...
                            p || (n.init({ appId: e.app_id || e.appId, appKey: e.app_key || e.appKey }), p = !0), t.v = n
                        } catch (e) { var w = "https://github.com/DesertsP/Valine/issues"; return void(t.el ? t.nodata.show('<pre style="color:red;text-align:left;">' + e + "<br>Valine:<b>" + t.version + "</b><br>feedback：" + w + "</pre>") : console && console.log("%c" + e + "\n%cValine%c" + t.version + " " + w, "color:red;", "background:#000;padding:5px;line-height:30px;color:#fff;", "background:#456;line-height:30px;padding:5px;color:#fff;")) }
                        ...
                        A.innerHTML = k, t.loading = { show: function() { A.setAttribute("style", "display:block;"), t.nodata.hide() }, hide: function() { A.setAttribute("style", "display:none;"), 0 === t.el.querySelectorAll(".vcard").length && t.nodata.show() } };
                        var S = t.el.querySelector(".vsubmitting");
                        S.innerHTML = k, t.submitting = { show: function() { S.setAttribute("style", "display:block;") }, hide: function() { S.setAttribute("style", "display:none;"), t.nodata.hide() } };
                        ...
                        t.alert = {
                            show: function(e) {
                                ...
                                if (n.innerHTML = "" + r + (e.type && i), _.querySelector(".vcancel").addEventListener("click", function(e) { t.alert.hide() }), _.setAttribute("style", "display:block;"), e && e.type) {
                                    var o = _.querySelector(".vsure");
                                    v.on("click", o, function(n) { t.alert.hide(), e.cb && e.cb() })
                                }
                            },
                            hide: function() { _.setAttribute("style", "display:none;") }
                        }, t.loading.show();
                        ...
                        T.notEqualTo("isSpam", !0), T.count().then(function(n) { t.el.querySelector(".count").innerHTML = "" + n, t.bind(e) }, function(e) { console.log(e) })
                    }
                }, {
                    key: "bind",
                    value: function(e) {
                        ...
                        v.on("click", r, function(e) { r.setAttribute("style", "display:none"), t.el.querySelector(".auth-section").removeAttribute("style"), t.el.querySelector(".veditor").focus() }), v.on("click", t.el.querySelector(".vcancel-comment-reply"), function(e) { t.reset() });
                        var i = function(e) { e.offsetHeight > 180 && (e.classList.add("expand"), v.on("click", e, function(t) { e.setAttribute("class", "vcomment") })) },
                            l = 1,
                            c = 0,
                            p = function e() {
                                var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1;
                                t.loading.show(), t.v.Query.doCloudQuery("select nick, comment, link, rid, emailHash, isSpam\n                                                   from Comment\n                                                   where (rid='' or rid is not exists) and (url='" + u.url + "' or url='" + u.url + "/')\n                                                   order by -createdAt\n                                                   limit " + (n - 1) * h + "," + h).then(function(r) {
                                    r = r && r.results || [];
                                    var i = r.length;
                                    if (i) {
                                        for (var o = 0; o < i; o++)
                                        ...
                                        u && v.on("click", u, function(t) { s.innerHTML = "", e(++l) })
                                    }
                                    t.loading.hide()
                                }).catch(function(e) { console.log(e), t.loading.hide() })
                            };
                        t.v.Query.doCloudQuery("select count(*)\n                                    from Comment\n                                    where (rid='' or rid is not exists) \n                                           and (url='" + u.url + "' or url='" + u.url + "/')\n                                    order by -createdAt").then(function(e) { c = e.count, p(1) });
                        var f = function e(n) {
                                var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1,
                                    i = n.querySelector(".vcomment-children"),
                                    o = i.querySelector(".vlist"),
                                    a = n.getAttribute("id");
                                if (r <= 0 && i.setAttribute("style", "margin-left: 0 !important"), r >= d) return void t.v.Query.doCloudQuery("select count(*)\n                               from Comment\n                               where rid='" + a + "' and (url='" + u.url + "' or url='" + u.url + "/')\n                               order by -createdAt").then(function(r) {
                                    if (r.count > 0) {
                                        var o = i.querySelector(".vshow-children-wrapper");
                                        o.setAttribute("style", "display: block !important;"), o.innerHTML = '<span class="vshow-children" rid="' + a + '">' + t.i18n.more + "</span>";
                                        var s = o.querySelector(".vshow-children");
                                        v.on("click", s, function(t) { o.setAttribute("style", "display: none !important;"), e(n, -1e3) })
                                    }
                            ...
                            m = function(e) {
                                ...
                                var a = e.get("emailHash"),
                                    s = "https://gravatar.loli.net/avatar/" + a + "?size=80&d=https%3a%2f%2fgravatar.loli.net%2favatar%2f9e63c80900d106cbbec5a9f4ea433a3e.jpg%3fsize%3d80";
                            ...
                            x = { veditor: "comment", vnick: "nick", vlink: "link", vmail: "mail" },
                            w = {};
                        for (var k in x) x.hasOwnProperty(k) && function() {
                            var e = x[k],
                                n = t.el.querySelector("." + k);
                            w[e] = n, v.on("input", n, function(t) { u[e] = n.value })
                        }();
                        var A = function() {
                            ...
                            if (e) {
                                ...
                                if ("" != e.mail) { t.el.querySelector(".visitor_avatar").setAttribute("src", "https://gravatar.loli.net/avatar/" + s(e.mail.toLowerCase().trim()) + "?size=80&d=https%3a%2f%2fgravatar.loli.net%2favatar%2f9e63c80900d106cbbec5a9f4ea433a3e.jpg%3fsize%3d80") }
                            }
                        };
                        A(), t.reset = function() {
                            for (var e in x)
                                if (x.hasOwnProperty(e)) {
                                    ...
                                    r.value = "", u[n] = ""
                                } u.rid = "", u.nick = "", A(), C.getAttribute("triggered") && (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")), L.getAttribute("triggered") && (L.setAttribute("style", "display:none;"), L.removeAttribute("triggered")), t.el.querySelector(".vcancel-comment-reply").setAttribute("style", "display:none"), t.el.querySelector("#vinputs-placeholder").appendChild(t.el.querySelector(".vinputs-wrap"))
                        };
                        var S = t.el.querySelector(".vsubmit"),
                            _ = function(n) {
                                if (S.getAttribute("disabled")) return void t.alert.show({ type: 0, text: '再等等，评论正在提交中ヾ(๑╹◡╹)ﾉ"', ctxt: "好的" });
                                if ("" == u.comment) return void w.comment.focus();
                                if ("" == u.nick) return void w.nick.focus();
                                if (u.comment = a(o(u.comment.replace(/!\(:(.*?\.\w+):\)/g, '<img src="' + e.emoticon_url + '/$1" alt="$1" class="vemoticon-img">')), { onIgnoreTagAttr: function(e, t, n, r) { if ("class" === t) return t + '="' + a.escapeAttrValue(n) + '"' } }), u.comment.indexOf(u.at) > -1 && "" != u.at) {
                                    var r = '<a class="at" href=\'#' + u.rid + "'>" + u.at + "</a>";
                                    u.comment = u.comment.replace(u.at, r)
                                }
                                var i = b.mail(u.mail),
                                    s = b.link(u.link);
                                u.mail = i.k ? i.v : "", u.link = s.k ? s.v : "", i.k && s.k ? I() : t.alert.show({ type: 0, text: t.i18n.input_tips, ctxt: t.i18n.confirm })
                            },
                            z = t.el.querySelector(".vemoji-btn"),
                            C = t.el.querySelector(".vsmile-icons");
                        v.on("click", z, function(e) { L.getAttribute("triggered") && (L.setAttribute("style", "display:none;"), L.removeAttribute("triggered")), C.getAttribute("triggered") ? (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")) : (C.removeAttribute("style"), C.setAttribute("triggered", 1)) });
                        var T = t.el.querySelector(".vpreview-btn"),
                            L = t.el.querySelector(".vpreview-text");
                        v.on("click", T, function(t) {
                            if (C.getAttribute("triggered") && (C.setAttribute("style", "display:none;"), C.removeAttribute("triggered")), L.getAttribute("triggered")) L.setAttribute("style", "display:none;"), L.removeAttribute("triggered");
                            else {
                                if ("" == u.comment) return void w.comment.focus();
                                L.innerHTML = a(o(u.comment.replace(/!\(:(.*?\.\w+):\)/g, '<img src="' + e.emoticon_url + '/$1" alt="$1" class="vemoticon-img">')), { onIgnoreTagAttr: function(e, t, n, r) { if ("class" === t) return t + '="' + a.escapeAttrValue(n) + '"' } }), L.removeAttribute("style"), L.setAttribute("triggered", 1)
                            }
                        });
                        var q = function() { var e = new t.v.ACL; return e.setPublicReadAccess(!0), e.setPublicWriteAccess(!1), e },
                            I = function() {
                                ...
                                for (var r in u)
                                    ...
                                    g && g.setItem("ValineCache", JSON.stringify({ nick: u.nick, link: u.link, mail: u.mail }));
                                ...
                                }).catch(function(e) { t.submitting.hide() })
                            },
                            $ = function(e) {
                                ...
                                v.on("click", r, function(i) {
                                    ...
                                    u.rid = a, u.at = o, w.comment.value = o + " ，" + w.comment.value, e.querySelector("#comment-" + n).appendChild(t.el.querySelector(".vinputs-wrap")), t.el.querySelector(".vcancel-comment-reply").removeAttribute("style"), t.el.querySelector(".comment_trigger").setAttribute("style", "display:none"), t.el.querySelector(".auth-section").removeAttribute("style"), t.el.querySelector(".veditor").focus(), w.comment.focus()
                                })
                            };
            ...
            v = { on: function(e, t, n, r) { t.addEventListener ? t.addEventListener(e, n, r || !1) : t.attachEvent ? t.attachEvent("on" + e, n) : t["on" + e] = n }, off: function(e, t, n, r) { t.removeEventListener ? t.removeEventListener(e, n, r || !1) : t.detachEvent ? t.detachEvent("on" + e, n) : t["on" + e] = null } },
            b = { mail: function(e) { return { k: /\w[-\w.+]*@([A-Za-z0-9][-A-Za-z0-9]+\.)+[A-Za-z]{2,14}/.test(e), v: e } }, link: function(e) { return e.length > 0 && (e = /^(http|https)/.test(e) ? e : "http://" + e), { k: !(e.length > 0) || /(http|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:\/~\+#]*[\w\-\@?^=%&amp;\/~\+#])?/.test(e), v: e } } },
            y = function(e, t) {
                try {
                    var n = e.getTime(),
                        r = (new Date).getTime(),
                    ...
                    if (0 === o) {
                        ...
                        if (0 === s) {
                            var l = a % 36e5,
                                c = Math.floor(l / 6e4);
                            if (0 === c) { var u = l % 6e4; return Math.round(u / 1e3) + " " + t.seconds }
                            return c + " " + t.minutes
                        }
                        return s + " " + t.hours
                    }
        ...
        function r(e) { return "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(e)))) + " */" } e.exports = function(e) {
            var t = [];
        ...
        o.prototype.process = function(e) {
            ...
            return s(e, function(e, t, n, s, c) {
                var u = i[n],
                    p = !1;
                if (!0 === u ? p = u : "function" == typeof u ? p = u(s) : u instanceof RegExp && (p = u.test(s)), !0 !== p && (p = !1), s = l(n, s)) { var d = { position: t, sourcePosition: e, source: c, isWhite: p }; if (p) { var h = o(n, s, d); return r(h) ? n + ":" + s : h } var h = a(n, s, d); return r(h) ? void 0 : h }
            })
        }, e.exports = o
    }, function(e, t, n) {
        function r(e, t) {
        ...
        function r(e, t) {
            for (var n = 0; n < e.length; n++) {
                var r = e[n],
                    i = f[r.id];
                if (i) { i.refs++; for (var o = 0; o < i.parts.length; o++) i.parts[o](r.parts[o]); for (; o < r.parts.length; o++) i.parts.push(u(r.parts[o], t)) } else {
        ...
        function u(e, t) {
            ...
            } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = l(t), r = h.bind(null, n, t), i = function() { a(n), n.href && URL.revokeObjectURL(n.href) }) : (n = s(t), r = d.bind(null, n), i = function() { a(n) });
            return r(e),
                function(t) {
                    if (t) {
        ...
        function i(e) {
            ...
            var n = "/" === e[e.length - 1];
            return n && (e = d.trim(e.slice(0, -1))), { html: e, closing: n }
        }
        ...
        a.prototype.process = function(e) {
            ...
            var b = u(e, function(e, t, n, l, u) {
                var v = { sourcePosition: e, position: t, isClosing: u, isWhite: o.hasOwnProperty(n) },
                    b = a(n, l, v);
                if (!r(b)) return b;
                if (v.isWhite) {
